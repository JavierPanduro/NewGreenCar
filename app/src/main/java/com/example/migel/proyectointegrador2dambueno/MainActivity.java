...
public class MainActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            TextView tvLoggedUser = (TextView) rootView.findViewById(R.id.loggedUser);

            if(loggedUser != null)
                tvLoggedUser.setText(loggedUser.getEmail());
            return rootView;
        }
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    Publicar_viaje publicar = new Publicar_viaje();
                    return publicar;
                case 1:
                    Mis_viajes viajes=new Mis_viajes();
                    return viajes;
                case 2:
                    Buscar_viajes buscar= new Buscar_viajes();
                    return buscar;
